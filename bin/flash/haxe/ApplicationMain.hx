...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("img/sprites.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("font/monkey.ttf");
		types.push (AssetType.FONT);
		
		
		urls.push ("font/pixel.ttf");
		types.push (AssetType.FONT);
	...
	public static function start ():Void {
		...
		for (methodName in Type.getClassFields (com.ukuleledog.games.evapixel.Main)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (com.ukuleledog.games.evapixel.Main, Reflect.field (com.ukuleledog.games.evapixel.Main, "main"), []);
...
@:keep class DocumentClass extends com.ukuleledog.games.evapixel.Main {}
